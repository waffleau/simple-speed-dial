...
function addSpeedDialBookmark(bookmark, entryArray) {
    ...
    var _local_storage_path = "custom_icon_data_" + bookmark.url;
    if (localStorage.getItem(_local_storage_path) != null) {
        entry.find(".image").css("background-image", "url(" + localStorage.getItem(_local_storage_path) + ")");
    }
